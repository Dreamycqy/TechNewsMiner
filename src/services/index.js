...
export function login(body, rSymbol) {
  return request.post({
    url: '/api/svc/ForeignLogin/login',
    data: body,
    rSymbol,
  })
}
...
export function search(body, rSymbol) {
  return request.post({
    url: '/api/svc/Foreign/queryNewsV2',
    data: body,
    rSymbol,
  })
}
...
export function subQueryNews(body, rSymbol) {
  return request.post({
    url: '/api/svc/Foreign/subQueryNewsV2',
    data: body,
    rSymbol,
  })
}
...
export function getFilterKeyword(body, rSymbol) {
  return request.get({
    url: '/api/svc/Foreign/getFilterKeyword',
    data: body,
    rSymbol,
  })
}
...
export function updateFilterKeyword(body, rSymbol) {
  return request.post({
    url: '/api/svc/Foreign/updateFilterKeyword',
    data: body,
    rSymbol,
  })
}
